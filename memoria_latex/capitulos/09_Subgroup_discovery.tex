...
% Una vez completado el descubrimiento de subgrupos, se ha realizado un análisis exploratorio adicional para comprobar si las reglas representativas permitían definir poblaciones suficientemente homogéneas como para entrenar modelos de imagen específicos.
...
La ablación se ha realizado sobre los 201 pacientes con información completa. Se ha comprobado la presencia de los 25 folds para cada combinación de representación y objetivo, obteniéndose los 225 resúmenes esperados.
