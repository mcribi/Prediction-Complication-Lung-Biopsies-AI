...
El análisis de las imágenes de TC se ha realizado inicialmente sobre los datos disponibles en formato DICOM. De los 210 pacientes de la cohorte inicial, se han identificado imágenes de TC válidas para 209 pacientes. Posteriormente, al comprobar su correspondencia con los volúmenes convertidos a formato NIfTI, se han encontrado 206 volúmenes disponibles, por lo que cuatro pacientes no se han incorporado a los análisis posteriores de imagen.

Durante la comprobación de la correspondencia entre ambas fuentes se ha detectado un número muy reducido de volúmenes repetidos asociados a registros tabulares con información diferente. Esta inconsistencia podría deberse a un error durante la recogida o la asociación de los datos por parte del equipo médico. Para evitar que un mismo estudio apareciera vinculado a pacientes distintos, los casos duplicados se han eliminado de los análisis posteriores basados en imagen.
...
\begin{figure}[!htbp]
    \centering
    \includeprivategraphic[width=\textwidth]{imagenes/eda/control_visual_calidad_ct_publica.png}
...
El preprocesamiento comprendió la implementación del pipeline mediante MONAI, la homogeneización espacial de los volúmenes, el aumento de datos, la aplicación de ventanas de Hounsfield y la incorporación de segmentaciones anatómicas a las representaciones de entrada.
...
\begin{figure}[!htbp]
    \centering
    \includeprivategraphic[width=\textwidth]{imagenes/eda/hu_ejemplos.png}
