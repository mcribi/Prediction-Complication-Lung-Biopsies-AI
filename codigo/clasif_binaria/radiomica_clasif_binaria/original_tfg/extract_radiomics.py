...
IMAGES_DIR = f"../volumenes_preprocesados/{PREPROC_NAME}/nifti/images"
MASKS_DIR  = f"../volumenes_preprocesados/{PREPROC_NAME}/nifti/masks_lung"
OUTPUT_NAME = f"./data/radiomic_data/200pacientes/radiomics_features_{PREPROC_NAME}"
