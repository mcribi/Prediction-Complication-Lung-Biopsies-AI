...
PILOT_CONFIGS = [
    {
        ...
        'batch_size': 4,
        'scratch_oof_f1_micro': 0.5198412698412699,
        'scratch_oof_f1_macro': 0.5043490291597945,
    },
    {
        ...
        'batch_size': 4,
        'scratch_oof_f1_micro': float('nan'),
        'scratch_oof_f1_macro': float('nan'),
    },
]
FREEZE_EPOCHS = 5
...
def run_pilot(pretraining: str, run_tag: str = '', config_indices: List[int] | None = None, batch_size_override: int | None = None) -> Path:
    ...
    setup = {
        ...
        'pilot_scope': 'rescue_line1_ct_simple_pretrained_one_channel_inputs',
