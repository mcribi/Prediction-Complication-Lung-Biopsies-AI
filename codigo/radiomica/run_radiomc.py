...
import os
# Debe estar antes de cualquier import de sklearn/joblib
...
# Activa faulthandler lo PRIMERO, para que cualquier crash nativo deje traza
import faulthandler
faulthandler.enable()
...
CONFIG_FILE = os.path.join(SCRIPT_DIR, "valid_configurations_radiomics_fixed.json")
OUTPUT_DB = os.path.join(PROJECT_ROOT, "radiomic_results", "sqlite_fixed", "results_radiomics.db")
